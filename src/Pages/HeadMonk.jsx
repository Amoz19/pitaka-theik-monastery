...
const HeadMonk = () => {
  ...
  return (
    <>
      <h1 className="text-3xl font-semibold px-20 py-2">ကျောင်းထိုင်ဆရာတော်</h1>
      <div className="flex flex-col items-center">
        ...
        />
        <button className="w-fit flex bg-primary text-white text-2xl my-4 px-6 py-2 rounded-3xl">
          <PhFacebookLogo />
          <BxBxlGmail />
          <MaterialSymbolsCallOutlineSharp />
        </button>
        <div className="bg-secondary/50 text-slate-900 p-4 rounded-xl w-2/4 m-auto">
